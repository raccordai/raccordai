...
export const kling3: ModelDefinition<Params> = {
  ...
  // No cheaper sibling — draft = same model in std (720p) mode.
  draftEquivalent: { modelId: 'kling-3.0/video', params: { mode: 'std' } },
  paramsSchema,
  paramFields: [
    {
      key: 'prompt',
    ...
    },
    {
      ...
      description: 'std=720p, pro=1080p, 4K=2160p. Higher modes cost more and take longer.'
    },
    {
      key: 'sound',

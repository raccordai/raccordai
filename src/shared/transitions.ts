...
export const CLIP_TRANSITIONS: readonly ClipTransitionDef[] = [
  ...
  { id: 'fadegrays', xfade: 'fadegrays' },
  { id: 'wipeleft', xfade: 'wipeleft' },
  { id: 'wiperight', xfade: 'wiperight' },
  { id: 'wipeup', xfade: 'wipeup' },
  { id: 'wipedown', xfade: 'wipedown' },
  { id: 'slideleft', xfade: 'slideleft' },
  { id: 'slideright', xfade: 'slideright' },
  { id: 'slideup', xfade: 'slideup' },
  { id: 'slidedown', xfade: 'slidedown' },
  { id: 'smoothleft', xfade: 'smoothleft' },
  { id: 'smoothright', xfade: 'smoothright' },
  { id: 'circleopen', xfade: 'circleopen' },
  { id: 'circleclose', xfade: 'circleclose' },
  { id: 'radial', xfade: 'radial' },
  { id: 'rectcrop', xfade: 'rectcrop' },
  { id: 'distance', xfade: 'distance' },
  { id: 'squeezeh', xfade: 'squeezeh' },
  { id: 'squeezev', xfade: 'squeezev' },
  { id: 'zoomin', xfade: 'zoomin' },
  { id: 'hblur', xfade: 'hblur' },
